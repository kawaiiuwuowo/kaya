...
//command
  if(message.author.id != OWNERID){
    ...
    .setDescription("<a:IX_wrongverify:632953533905502258> This Command Only Use By The Owner! ")
    .setColor("YELLOW");
...
.setTitle(`**[Support Server]**`)
  ...
  .addFields(
    ...
    { name: "<a:Dot:888402396429037588> Bot Owner:",value: `\`\`\`!DevCuddly~\`\`\``},
  )
  .setColor("3498DB")
  .setFooter("Thx For Choosing !devcuddly")  
